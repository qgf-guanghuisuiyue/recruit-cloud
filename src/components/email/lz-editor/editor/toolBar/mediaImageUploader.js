...
var ImgStyleControls = function (_Component) {
  ...
  _createClass(ImgStyleControls, [{
    ...
    value: function successLoading(type) {
      ...
      var pfopImages = this.state.images;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.images.map(function (item, index) {
            return _react2.default.createElement('img', { key: index, style: { width: "100px" }, src: item.url,
              onError: function onError(event) {
                return _this2.failureLoading(event, index);
              },
              onLoad: function onLoad() {
                return _this2.successLoading("fromImg");
              } });
          })
        ),
        _react2.default.createElement(
